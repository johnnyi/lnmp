...
SRV=http://source.holdlinux.com/soft/linux/nginx_php/mysql/mysql-5.5.8.tar.gz
...
./configure --prefix=/usr/local/mysql  --datadir=/data/mysql/3306/data --user=mysql --defaults-file=/usr/local/mysql/etc/my.cnf --without-debug --with-client-ldflags=-all-static --with-mysqld-ldflags=-all-static --enable-assembler --with-extra-charsets=gbk,gb2312,utf8 --with-pthread --enable-thread-safe-client --with-plugins=innobase
